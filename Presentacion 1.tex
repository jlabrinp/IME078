...
\begin{frame}{1.3 Problemas Propuestos: Geometría Básica y Segmentos}
...
\begin{enumerate}
    ...
    \item \textbf{Punto Medio:} Determine el valor de $k$ para que la distancia entre $P(k, 2)$ y $Q(3, -1)$ sea exactamente $5$ unidades.
\end{enumerate}
\end{block}
\end{frame}
