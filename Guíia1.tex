...
\begin{ex}
En el plano cartesiano se consideran los puntos
$A(1,2),\qquad B(5,6),\qquad C\left(\frac{19}{7},\frac{26}{7}\right).
$
Si los tres puntos son colineales.
Determina la razón en que el punto $C$ divide al segmento $\overline{AB}$.
\begin{sol} $\frac{AC}{CB}=\frac{3}{4}$
\end{sol}
\end{ex}
